...
describe('Roles', () => {
   ...
   it('should return status 200 when get all users on the database by an admin user', async () => {
   ...
   it('should return status 403 when get all users on the database by a normal user', async () => {
...
describe('Create new user', () => {
   ...
   it('should return status 200 when a new user was created', async () => {
   ...
   it('should return status 202 when a new user was created with an email already registered', async () => {
      ...
      expect(responseCreate.status).toBe(202)
   })
})
...
describe('Update user', () => {
   ...
   it('should return status 200 when a user updated with an active token', async () => {
   ...
   it('should return status 401 when a user updated with an inactive token', async () => {
